...
void Board::updateBoardState() {
    ...
    std::vector<std::vector<Cell>> tempBoard(board_.size(), std::vector<Cell>(board_[0].size()));
...
void Board::calculateNewBoardState(std::vector<std::vector<Cell>>& tempBoard)
{
